...
\homework{$11^{th}$ and $12^{th}$ Week Summary}{11/19/26}
\vspace{-0.4 in}
\begin{itemize}
\item \textbf{ANOVA}: If the assumption of the equality of variances fails \dotfill
\item We ``transform'' the data. The common transformations are
